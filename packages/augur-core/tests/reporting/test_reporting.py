...
def test_forking_values(localFixture, universe, market):
    ...
    assert childUniverse.getDisputeThresholdForFork() == childUniverseTheoreticalSupply / 40
    assert childUniverse.getInitialReportMinValue() == childUniverse.getDisputeThresholdForFork() / 3 / 2**18 + 1
